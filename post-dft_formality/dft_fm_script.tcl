...
read_verilog -container Ref "RX_paity_check.v"
read_verilog -container Ref "RX_stp_chk_block.v"
read_verilog -container Ref "RX_str_chk._block.v"
read_verilog -container Ref "RX_TOP.v"
...
read_verilog -container Ref "TX_TOP.v"
